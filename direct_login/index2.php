...
$PAGE->set_url("$CFG->wwwroot/login/index2.php");
$PAGE->set_context($context);
$PAGE->set_pagelayout('login');
$SESSION->wantsurl= $CFG->wwwroot.'/course/view.php?id=2';
...
if (empty($SESSION->wantsurl)) {
    ...
    if ($referer &&
            ...
            strpos($referer, $CFG->wwwroot . '/login/index2.php') !== 0) { // There might be some extra params such as ?lang=.
